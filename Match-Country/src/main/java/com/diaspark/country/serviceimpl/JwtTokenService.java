...
import com.diaspark.country.exception.UsernameNotFoundException;
...
/*	this  function return the password and  username for authenticate*/
	...
	public UserDetails loadUserByUsername(String userName) {
		...
		if(userDAO == null){
			throw new UsernameNotFoundException(userName+ " <--- : this username does not exist ");
		}
	/*	sendMail(userDAO) ;*/ 
